...
Still useful later (not required for that header strip): `SUPPORT.md`, issue/PR
templates, `FUNDING.yml`, `CITATION.cff`, and a `LICENSE` name alias if desired
alongside existing `LICENCE`.
