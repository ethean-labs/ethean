...
Design notes, sprint write-ups, and working plans for the client.
...
- [Networking / QUIC / gossip / HTTP](./networking/README.md) (37 notes)
- [Observability / metrics / Grafana](./observability/README.md) (20 notes)
...
- [architecture.md](./architecture.md) (stub → readme companion)
...
Session note for this layout:
[process/docs-topic-folders-2026-09-20.md](./process/docs-topic-folders-2026-09-20.md)
