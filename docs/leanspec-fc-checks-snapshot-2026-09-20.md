...
| Gap | Notes |
| --- | --- |
| Weight / payload snapshot fields | **blockWeights + payload pools landed** — see `leanspec-fc-block-weights-snapshot-2026-09-20.md`, `leanspec-fc-payload-pools-snapshot-2026-09-20.md` |
