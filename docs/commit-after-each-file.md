...
Never leave Cursor / AI attribution on commits (`Co-authored-by: Cursor`, `cursoragent@cursor.com`, “Made with Cursor”). See [no-ai-git-attribution-2026-09-19.md](./no-ai-git-attribution-2026-09-19.md).
