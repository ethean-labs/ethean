...
impl ValidatorManager {
    ...
    pub fn request_exit(
        ...
        let _validator = state.validators.validators.get(validator_index.as_usize())
            .ok_or(ValidatorError::NotFound(validator_index))?;
    ...
    fn exit_validator(
        ...
        let validator = state.validators.validators.get_mut(validator_index.as_usize())
            .ok_or(ValidatorError::NotFound(validator_index))?;
    ...
    pub fn detect_slashing_conditions(
        ...
        let validator = match state.validators.validators.get(validator_index.as_usize()) {
            Some(v) => v,
    ...
    pub fn update_balance(
        ...
        let balance = state.balances.get_mut(validator_index.as_usize())
