...
- **Genesis state / block root pins**: [docs/genesis-state-root-pin-2026-09-25.md](./docs/lean-spec/genesis-state-root-pin-2026-09-25.md)
- **Proof queue priority / Type-2 retry**: [docs/proof-queue-priority-type2-retry-2026-09-25.md](./docs/lean-crypto/proof-queue-priority-type2-retry-2026-09-25.md)
- **Head-behind-finalized + local Hive smoke**: [docs/head-behind-finalized-local-smoke-2026-09-25.md](./docs/hive-testing/head-behind-finalized-local-smoke-2026-09-25.md)
- **Majority Status tip / bad-checkpoint**: [docs/majority-status-tip-bad-checkpoint-2026-09-25.md](./docs/networking/majority-status-tip-bad-checkpoint-2026-09-25.md)
